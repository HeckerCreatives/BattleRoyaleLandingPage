...
{/* 
             <Dialog>
            <DialogTrigger>
              <div className=' hidden lg:hidden md:flex items-center justify-center w-[100px] h-[100px]'
                style={{backgroundImage: "url('/assets/triangle button HOLDER.png')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat:"no-repeat"}}
              >
            ...
            <DialogContent className=' w-[95%] md:w-auto text-white  h-auto p-4 bg-zinc-950 border-zinc-900 flex flex-col items-center gap-4'>
