  ...
  return (
    ...
    >
        ...
        <div className=' flex flex-col items-center justify-center gap-10 '>
            <h2 className=' text-2xl lg:text-4xl font-bold italic text-white font-gilgond'>Subscribe to our news letter!</h2>
            <div className=' flex lg:flex-row flex-col items-center justify-center gap-4'>
                <input value={email} onChange={(e) => setEmail(e.target.value)} type="text" name="" id="" placeholder='ENTER YOUR EMAIL' className=' text-xl font-bold px-6 text-white bg-zinc-950 bg-opacity-5 rounded-lg h-[50px] md:w-[400px] lg:w-[750px]'
