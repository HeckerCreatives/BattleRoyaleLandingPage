...
export default function About() {
  ...
  useEffect(()=>{
    ...
    return (
    <div id='about' className=' w-full h-auto flex flex-col ~gap-4/12 items-center justify-center py-20 mt-12 '
    ...
    >
        ...
        {/* {data.map((data)=>(
        <div className='relative w-full h-auto flex lg:flex-row flex-col items-center gap-5'>
